...
\newcommand{\usecaseincl}[1]{\textbf{Include:} #1}
\newcommand{\usecasegen}[1]{\textbf{Generalizza:} #1}
\newcommand{\usecasesecondactors}[1]{\textbf{Secondary actors:} #1}
...
% Elementi descrittivi aggiuntivi per il blocco usecase
